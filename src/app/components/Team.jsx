        ...
        <>
          <div className="list mt-10 w-full px-10">
            ...
            >
              ...
              <div
                className={`picture${index} opacity-0 absolute z-[4] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[15rem] h-[15rem] overflow-hidden rounded-full bg-blue-500`}
              >
                <Image
